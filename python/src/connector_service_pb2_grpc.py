...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in connector_service_pb2_grpc.py depends on'
...
def add_ConnectorServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('profilence.zeta.ConnectorService', rpc_method_handlers)
